...
export class FollowResolver {
	...
	public async subscribe(
		...
		const followingId = shapeOfMongoObjectId(input);
	...
	public async getMemberFollowings(
		...
		input.search.followerId = shapeOfMongoObjectId(followerId);
	...
	public async getMemberFollowers(
		...
		input.search.followingId = shapeOfMongoObjectId(followingId);
