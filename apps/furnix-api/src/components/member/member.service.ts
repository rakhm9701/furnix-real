...
export class MemberService {
	...
	public async signup(input: MemberInput): Promise<Member> {
		...
		try {
			...
			throw new BadRequestException(Message.USED_MEMBER_NICK_ORPHONE);
		}
	}
	...
	public async getMember(memberId: ObjectId, targetId: ObjectId): Promise<Member> {
		...
		if (memberId) {
			...
			targetMember.meFollowed = await this.checkSubscibtion(memberId, targetId);
		}
		return targetMember;
	}

	//checkSubscibtion
	private async checkSubscibtion(followerId: ObjectId, FollowingId: ObjectId): Promise<MeFollowed[]> {
